...
const initialState: PermissionsState = {
  permissions: [
    ...
    { id: 'pages', name: 'Pages', description: 'Manage pages', rights: ['read'], parentId: undefined },
    { id: 'edit-pages', name: 'Edit Pages', description: 'Create and edit pages', rights: ['write'], parentId: 'pages' },
    { id: 'delete-pages', name: 'Delete Pages', description: 'Delete pages', rights: ['delete'], parentId: 'pages' },
    { id: 'publish-pages', name: 'Publish Pages', description: 'Publish pages', rights: ['write'], parentId: 'pages' },
